...
function handleSubmit() {
    ...
    form.patch(`${props.toggleUrl}/${props.warehouse.id}/toggle-status`, {
        onSuccess: () => {
            ...
            <div class="px-6 pt-6 pb-0">
                <DialogHeader>
                    <DialogTitle class="text-lg font-semibold text-gray-900">
                        {{ isDeactivating ? 'Konfirmasi Nonaktifkan' : 'Aktifkan Warehouse' }}
                    </DialogTitle>
                </DialogHeader>
            </div>
            ...
            <div class="px-6 pt-4 pb-5 grid gap-5">
                ...
                <div v-if="isDeactivating"
                    ...
                    <div class="flex-1 text-sm text-amber-800 leading-snug">
                        Warehouse yang dinonaktifkan tidak dapat digunakan untuk transaksi baru. Data historis tetap tersimpan.
                    </div>
                ...
                <div v-else class="flex items-start gap-3 rounded-lg border border-emerald-200 bg-emerald-50 px-4 py-3">
                    ...
                    <div class="flex-1 text-sm text-emerald-800 leading-snug">
                        Warehouse akan diaktifkan kembali dan dapat digunakan dalam transaksi baru.
                    </div>
