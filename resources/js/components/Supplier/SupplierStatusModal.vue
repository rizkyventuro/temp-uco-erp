...
import type { Supplier } from '@/components/Supplier/SupplierFormModal.vue';
            ...
            <div class="px-6 pt-4 pb-5 grid gap-5">
                ...
                <p class="text-sm text-gray-800">
                    <template v-if="isDeactivating">
                        Anda yakin ingin menonaktifkan supplier <strong>"{{ supplier?.name }}"</strong>?
                    </template>
                    <template v-else>
                        Anda yakin ingin mengaktifkan kembali supplier <strong>"{{ supplier?.name }}"</strong>?
                    </template>
                </p>
