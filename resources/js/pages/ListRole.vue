...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
            ...
            <div class="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                ...
                <div class="flex w-full justify-end  md:w-auto md:flex-shrink-0">
                    <div class="flex flex-col gap-2 md:flex-row">
                        <Button v-if="can(PermissionEnum.CREATE_ROLE)"
                ...
                <div v-for="role in roles" :key="role.id"
                    ...
                    <div class="mb-3 flex items-start justify-between">
                        ...
                        <div class="flex gap-1">
                            <button v-if="can(PermissionEnum.EDIT_ROLE)" @click="openEdit(role)"
                            ...
                            <button v-if="can(PermissionEnum.DELETE_ROLE)" @click="destroy(role)"
        ...
        <!-- Modal -->
        <RoleFormModal :show="showModal" :permissions="permissions" :edit-target="editTarget" @close="closeModal" />
    </AppLayout>
</template>